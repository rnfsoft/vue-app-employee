  ...
  export default {
    ...
    methods:{
      addEmployee(employee){
        ...
        // console.log(newEmployee); //Object { name: "adsfads", email: "adfsad", id: 4 }
        
        this.employees = [...this.employees, newEmployee]; //“spread operator” and expands an array into a list.
      },
      deleteEmployee(id){
